...
static int check_vma_flags(struct vm_area_struct *vma, unsigned long gup_flags)
{
  ...
  * https://lists.linaro.org/pipermail/linaro-mm-sig/2014-July/003977.html
  */
static int get_page2(struct mm_struct *mm, struct vm_area_struct *vma,
