...
#include <linux/wakelock.h> // add by leo
...
//add by angel_ko to pull high irq
...
struct synaptics_rmi4_device_info {
	...
	unsigned char ctrl10[CTRL10_NUM];
...
struct synaptics_rmi4_data {
	...
	struct delayed_work proxi_notify_work;
	struct workqueue_struct *rb_workqueue;
	struct workqueue_struct *proxi_notify_workqueue;
	...
	struct wake_lock synaptics_wakelock;
	bool enable_gloved;
