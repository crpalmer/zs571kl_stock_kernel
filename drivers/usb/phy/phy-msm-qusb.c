...
module_param(PHY_PORT_TUNE5, uint, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(PHY_PORT_TUNE5, "QUSB PHY TUNE5");
// ASUS_BSP --- Support Dynamic Tuning PHY Parameters
...
static int qusb_phy_init(struct usb_phy *phy)
{
	...
	if(PHY_PORT_TUNE5)
	{
		writel_relaxed(PHY_PORT_TUNE5,qphy->base + QUSB2PHY_PORT_TUNE5);
		temp = readb_relaxed(qphy->base + QUSB2PHY_PORT_TUNE5);
		printk("QUSB2PHY_PORT_TUNE5 : %02x\n",temp);
	}
	printk("QUSB2PHY_PORT_TUNE1:%02x,QUSB2PHY_PORT_TUNE2:%02x,QUSB2PHY_PORT_TUNE3:%02x,QUSB2PHY_PORT_TUNE4:%02x,QUSB2PHY_PORT_TUNE5:%02x\n",
