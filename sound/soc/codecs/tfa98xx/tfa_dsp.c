...
enum Tfa98xx_Error tfa98xxCalSetCalibrateOnce(Tfa98xx_handle_t handle)
{
	return tfa98xx_set_mtp(handle, 1<<TFA_MTPOTC_POS, 1<<TFA_MTPOTC_POS);
	/* handle val mask */
}
...
enum Tfa98xx_Error tfaRunSpeakerStartup(Tfa98xx_handle_t handle, int force, int profile)
{
	...
	// DSP is running now.
	tfa98xxCalSetCalibrateOnce(handle);
